...
// Define a very specific symbol so we can detect if this is our 'fixed' hack version or the original MS Visual Studio 2017 version.
// This has originally been based on the MS Visual Studio 2010 -- this is now a refresh based on the MS Visual Studio 2017 header.
// https://social.msdn.microsoft.com/Forums/vstudio/en-US/357fe69b-1eec-467b-bb5f-4a4606b320f5/vs2010-error-c2491-stdnumpunctelemid-while-using-stdbasicfstreamunsigned-char-in?forum=vcgeneral
...
protected:
	...
	{	// get bool from [_First, _Last) into _Val
		...
		{	// get false name or true name
			...
			const _Mypunct& _Punct_fac = _STD use_facet<_Mypunct>(_Iosbase.getloc());
...
private:
	...
	{	// get integer field from [_First, _Last) into _Ac
		const _Mypunct& _Punct_fac = _STD use_facet<_Mypunct>(_Loc);
