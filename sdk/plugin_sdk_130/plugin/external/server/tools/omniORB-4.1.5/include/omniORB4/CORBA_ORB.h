...
public:
  ...
  // ---- This method returns when there is work avaiable. It can be used in
  //	  conjunction with perform_work. InDesignServer requires that any
  //	  corba requests are processed in the main thread. But the most 
  //	  efficient way to watch for work is on a thread. Use this method in
  //	  a thread to signal the main thread when work is available. [mburbidg]
