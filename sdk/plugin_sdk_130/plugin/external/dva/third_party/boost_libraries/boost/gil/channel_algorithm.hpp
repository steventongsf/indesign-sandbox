...
// Silence Xcode 8.2.1:
// error: non-type template argument evaluates to -1, which cannot be narrowed to type 'unsigned long'
struct unsigned_integral_max_value : public mpl::integral_c<UnsignedIntegralChannel,~UnsignedIntegralChannel(0)> {};
