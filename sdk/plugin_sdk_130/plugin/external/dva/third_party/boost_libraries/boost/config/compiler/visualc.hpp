...
// ADBE hack: compile with VS2017 w v401 tool chain (VS2015).
//           VS2017 has started adding updates for the least sig digit.
//           This should support until the next VS major version.
#if (_MSC_VER > 1920)
#  if defined(BOOST_ASSERT_CONFIG)
