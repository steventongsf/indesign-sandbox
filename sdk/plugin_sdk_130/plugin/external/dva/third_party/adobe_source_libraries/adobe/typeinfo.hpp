...
/**************************************************************************************************/
		...
		struct ASL_DECL type_instance_t
{
...
O serialize(const type_instance_t& x, O out)
{
    ...
    return out;
		...
		ASL_DECL bool before(const type_instance_t& x, const type_instance_t& y);
		ASL_DECL bool operator==(const type_instance_t& x, const type_instance_t& y);
...
*/
#if ADOBE_PLATFORM_WIN || defined(_WINDOWS)
#pragma warning( push )
#pragma warning( disable : 4251) 
#pragma warning( disable : 4275) 
#endif
	class ASL_DECL bad_cast : public std::bad_cast
{
 public:
    bad_cast();
