...
*/
#if ADOBE_COMPILER_MSVC
			template class ASL_DECL					   vector<char>;
#endif	
			
		class ASL_DECL string_t : boost::totally_ordered<string_t, string_t, empty_base_t<string_t> >
{
 public:
 ...
 */
#if ADOBE_COMPILER_MSVC
		template class ASL_DECL								  vector<boost::uint16_t>;
#endif

		class ASL_DECL string16_t : boost::totally_ordered<string16_t, string16_t, empty_base_t<string16_t> >
{
public:
