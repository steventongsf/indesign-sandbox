...
/*!
    ...
    engine.
*/
#ifndef VISIBILITYSPEC
#ifdef ADOBE_PLATFORM_MAC
	#define	VISIBILITYSPEC __attribute__((visibility("default")))
#elif ADOBE_PLATFORM_WIN
	#define VISIBILITYSPEC  __declspec(dllexport) 
#endif

#endif
class VISIBILITYSPEC sheet_t : boost::noncopyable
{
 public:
    struct relation_t;
