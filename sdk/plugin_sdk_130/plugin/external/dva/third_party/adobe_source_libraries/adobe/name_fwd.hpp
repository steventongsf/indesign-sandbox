...
class ASL_DECL name_t : boost::totally_ordered<name_t, name_t>
{
 private:
    operator int () const;
 public:
...
typedef version_1::name_t name_t;
typedef version_1::static_name_t static_name_t;
typedef version_1::aggregate_name_t aggregate_name_t;
